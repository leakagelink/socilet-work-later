...
function Home() {
  return (
    <>
      ...
      <main>
        {/* Hero */}
        <section className="relative overflow-hidden bg-gradient-hero px-5 pb-10 pt-6">
          <img
            src={heroBg}
            alt=""
            aria-hidden
          ...
          <div className="relative">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-xs font-medium text-primary-glow">
              <Sparkles className="h-3 w-3" /> Work First, Pay Later
            </span>
            <h1 className="mt-4 font-display text-3xl font-bold leading-tight">
              Brand your dream with <span className="text-gradient">Socilet</span>
            </h1>
            <p className="mt-3 text-sm text-muted-foreground">
              Websites, apps, AI and growth — built by a senior team. Start without paying upfront.
            </p>
