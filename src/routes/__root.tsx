...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Socilet — Work First, Pay Later | Web, App & AI Development" },
      { property: "og:description", content: "Socilet builds websites, mobile apps, AI solutions, SEO, social media & Google Ads. Start your project today — work first, pay later." },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "/og-image.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "/og-image.png" },
      { name: "twitter:title", content: "Socilet — Work First, Pay Later | Web, App & AI Development" },
      { name: "twitter:description", content: "Socilet builds websites, mobile apps, AI solutions, SEO, social media & Google Ads. Start your project today — work first, pay later." },
    ],
    links: [
